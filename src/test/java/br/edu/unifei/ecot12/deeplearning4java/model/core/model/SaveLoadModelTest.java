...
public class SaveLoadModelTest {
    ...
    public void testLoadLinearModel() throws Exception {
        ...
        String filePath = "src/test/java/br/edu/unifei/ecot12/deeplearning4java/model/core/model/linear_regression.bin";
...
//              [340.9742]]
    ...
    public void testLoadSineModel() {
        // Carrega o modelo do arquivo
        String filePath = "src/test/java/br/edu/unifei/ecot12/deeplearning4java/model/core/model/sine_function.zip";
        ...
        assertTrue(layers.get(0) instanceof Dense);
        Dense denseLayer = (Dense) layers.get(0);
        assertEquals(10, denseLayer.getUnits());
