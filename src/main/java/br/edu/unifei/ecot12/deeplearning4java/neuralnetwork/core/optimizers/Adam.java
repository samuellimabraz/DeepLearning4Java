...
public class Adam extends Optimizer {
    ...
    protected List<INDArray>  createAuxParams(INDArray params) {
        ...
        auxParams.add(Nd4j.zeros(params.shape())); // m
        auxParams.add(Nd4j.zeros(params.shape())); // v
        return auxParams;
    }
    ...
    public void updateRule(INDArray params, INDArray grads, List<INDArray>  auxParams) {
        ...
        INDArray mHat = m.div(1 - Math.pow(beta1, t));
        INDArray vHat = v.div(1 - Math.pow(beta2, t));
