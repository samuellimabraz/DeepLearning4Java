...
import br.edu.unifei.ecot12.deeplearning4java.neuralnetwork.core.optimizers.Adam;
...
public class TrainerBuilder {
    ...
    public TrainerBuilder setBatchSize(int batchSize) {
        ...
        if (batchSize > trainInputs.rows()) throw new IllegalArgumentException("Batch size must be less than the number of inputs");
